...
public class GlrAmbientLightCreationTest {
  ...
  public void noAdditionalDeclaredMethods() {
    java.lang.reflect.Method[] methods = GlrAmbientLight.class.getDeclaredMethods();
    assertEquals("GlrAmbientLight should declare no additional methods", 0, methods.length);
  }
