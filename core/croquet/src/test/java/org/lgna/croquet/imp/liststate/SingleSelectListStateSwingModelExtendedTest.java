...
public class SingleSelectListStateSwingModelExtendedTest {
  ...
  @Test public void comboBoxModel_elementAt() { assertEquals("a", state.getSwingModel().getComboBoxModel().getElementAt(0)); assertEquals("b", state.getSwingModel().getComboBoxModel().getElementAt(1)); }
  @Test public void comboBoxModel_selectedItem() { assertEquals("a", state.getSwingModel().getComboBoxModel().getSelectedItem()); }
  @Test public void comboBoxModel_selectedItem_afterChange() { state.setValueTransactionlessly("b"); assertEquals("b", state.getSwingModel().getComboBoxModel().getSelectedItem()); }
}
