...
public class HistoryListenerContractTest {
  ...
  @Test public void indexChanging(){CL l=new CL();l.insertionIndexChanging(new HistoryInsertionIndexEvent(new UndoHistory(G),0,1));assertEquals(1,l.c.get());}
  @Test public void indexChanged(){CL l=new CL();l.insertionIndexChanged(new HistoryInsertionIndexEvent(new UndoHistory(G),0,1));assertEquals(1,l.d.get());}
