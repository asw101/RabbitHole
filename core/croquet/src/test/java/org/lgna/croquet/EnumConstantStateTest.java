...
public class EnumConstantStateTest {
  ...
  @Test public void initialIndex() { assertEquals(Color.RED, state.getValue()); }
  ...
  @Test public void fourEnum() { EnumConstantState<Size> s=new EnumConstantState<>(G, UUID.fromString("e0000000-0000-0000-0001-000000000004"), 0, Size.class); CroquetTestUtils.removeListSelectionListeners(s); assertEquals(4, s.getItemCount()); }
