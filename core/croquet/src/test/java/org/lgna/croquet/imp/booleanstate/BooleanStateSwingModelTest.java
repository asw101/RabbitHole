...
public class BooleanStateSwingModelTest {
  ...
  @Test public void buttonModel_syncsBackToFalse() { state.setValueTransactionlessly(true); state.setValueTransactionlessly(false); assertFalse(state.getImp().getSwingModel().getButtonModel().isSelected()); }
