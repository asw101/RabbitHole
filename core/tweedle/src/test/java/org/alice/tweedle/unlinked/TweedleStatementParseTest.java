...
public class TweedleStatementParseTest {
  ...
  public void anEachTogetherValuesShouldHaveElementTypeSModel() {
    ...
    assertEquals("The EachTogether individual values should be typed as SModel.", valArrayType.getValueType(), tested.getLoopVar().getType());
  }
  ...
  public void aVariableDeclarationShouldHaveAnInitializerValue() {
    TweedleExpression tested = ((LocalVariableDeclaration) parseStatement("WholeNumber a <- 2;")).getDeclaration().getInitializer();
  ...
  public void aVariableDeclarationShouldHaveAnInitializerOfTwo() {
    TweedlePrimitiveValue tested = (TweedlePrimitiveValue) ((LocalVariableDeclaration) parseStatement("WholeNumber a <- 2;")).getDeclaration().getInitializer();
