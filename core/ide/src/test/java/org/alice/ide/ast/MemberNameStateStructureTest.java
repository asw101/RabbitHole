...
public class MemberNameStateStructureTest {

  @Test
  public void classReference_loaded_nonNull() {
    assertNotNull(MemberNameState.class);
  }

  @Test
  public void classModifiers_checked_publicFinal() {
    int modifiers = MemberNameState.class.getModifiers();
  ...
  public void typeParameter_checked_singleMemberBound() {
    TypeVariable<?>[] variables = MemberNameState.class.getTypeParameters();
  ...
  @Test
  public void superclass_checked_stringState() {
    assertEquals(StringState.class, MemberNameState.class.getSuperclass());
  }

  @Test
  public void interfaces_checked_noneDeclared() {
    assertEquals(0, MemberNameState.class.getInterfaces().length);
  }
  ...
  public void memberField_checked_privateFinalMember() throws Exception {
    Field field = MemberNameState.class.getDeclaredField("member");
  ...
  @Test
  public void constructorSignature_checked_singleMemberAccepted() throws Exception {
    Constructor<MemberNameState> constructor = MemberNameState.class.getDeclaredConstructor(Member.class);
  ...
  public void constructorCount_checked_singleConstructor() {
    assertEquals(1, MemberNameState.class.getDeclaredConstructors().length);
  }
  ...
  public void getMember_signature_checked_memberReturned() throws Exception {
    Method method = MemberNameState.class.getDeclaredMethod("getMember");
  ...
  @Test
  public void declaredConstructors_checked_memberParameterTypeRetained() {
    Class<?>[] parameterTypes = MemberNameState.class.getDeclaredConstructors()[ 0 ].getParameterTypes();
