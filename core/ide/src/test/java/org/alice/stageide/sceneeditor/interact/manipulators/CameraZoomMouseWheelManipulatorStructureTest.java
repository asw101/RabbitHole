...
public class CameraZoomMouseWheelManipulatorStructureTest extends AbstractLoadedClassStructureTest {
  @Override
  protected String getClassName() {
    return "org.alice.stageide.sceneeditor.interact.manipulators.CameraZoomMouseWheelManipulator";
  }
  ...
  protected String[] getExpectedInterfaceSimpleNames() {
    return new String[] {"AnimatorDependentManipulator"};
  }
}
