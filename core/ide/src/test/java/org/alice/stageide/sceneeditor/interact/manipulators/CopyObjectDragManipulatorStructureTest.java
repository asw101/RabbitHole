...
public class CopyObjectDragManipulatorStructureTest extends AbstractLoadedClassStructureTest {
  @Override
  protected String getClassName() {
    return "org.alice.stageide.sceneeditor.interact.manipulators.CopyObjectDragManipulator";
  }

  @Override
  protected String getExpectedSuperclassSimpleName() {
    return "OmniDirectionalBoundingBoxManipulator";
  }
