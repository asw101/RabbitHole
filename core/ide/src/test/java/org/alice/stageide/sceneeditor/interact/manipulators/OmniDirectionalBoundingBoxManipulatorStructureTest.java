...
public class OmniDirectionalBoundingBoxManipulatorStructureTest extends AbstractLoadedClassStructureTest {
  @Override
  protected String getClassName() {
    return "org.alice.stageide.sceneeditor.interact.manipulators.OmniDirectionalBoundingBoxManipulator";
  }

  @Override
  protected String getExpectedSuperclassSimpleName() {
    return "OmniDirectionalDragManipulator";
  }
  ...
  protected String[] getExpectedInterfaceSimpleNames() {
    return new String[] {"TargetManipulator"};
  }
}
