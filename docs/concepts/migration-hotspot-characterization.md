...
| Registry parity reference | [`docs/reference/text-migration-registry-characterization.md`](../reference/text-migration-registry-characterization.md) | Documents the JSON-backed registry contract, read-only parity checks, explicit regeneration command, and legacy registry parity gate. |
...
The [text migration registry characterization](../reference/text-migration-registry-characterization.md)
