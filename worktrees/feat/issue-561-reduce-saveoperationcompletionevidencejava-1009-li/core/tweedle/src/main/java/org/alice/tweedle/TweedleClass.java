...
public class TweedleClass extends TweedleType implements InvocableMethodHolder {
  ...
  private TweedleClass(String className, TweedleTypeReference superclass, List<TweedleField> properties, List<TweedleMethod> methods, List<TweedleConstructor> constructors) {
